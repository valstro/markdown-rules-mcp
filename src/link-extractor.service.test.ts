...
describe("LinkExtractorService", () => {
  ...
  beforeEach(() => {
    ...
    linkExtractorService = new LinkExtractorService(
      mockFileSystemService as unknown as FileSystemService
    );
  });
  ...
  it("should extract a single markdown link with ?include=true", () => {
    const content = "Some text [link text](./relative/link.md?include=true) more text.";
  ...
  it("should extract a single markdown link with ?include=1", () => {
    const content = "Some text [link text](./relative/link.md?include=1) more text.";
    const relativeLink = "./relative/link.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract multiple markdown links with ?include=true and ?include=1", () => {
    const content = `
      First link: [link1](../link1.md?include=true)
      Second link: [link2](./folder/link2.md?include=true&other=param)
      Third link: [link3](./folder/link3.md?include=1&other=param)
      Some other text.
    `;
  ...
  it("should ignore links without ?include=true or ?include=1", () => {
    const content = `
      [link1](./link1.md)
      [link2](./link2.md?include=false)
  ...
  it("should handle links with HTML entities like &amp;", () => {
    const content = "Link: [encoded link](./path/to/file&amp;stuff.md?include=true)";
  ...
  it("should handle path resolution errors gracefully", () => {
    const content = `
      [Valid Link](./valid.md?include=true)
      [Link Causing Resolution Error](./error-path.md?include=true)
    `;
  ...
  it("should correctly resolve paths relative to the source document's directory", () => {
    const content = "[link](./relative/path/doc.md?include=true)";
  ...
  it("should correctly resolve absolute paths relative to the source document's directory (using resolvePath)", () => {
    const content = "[link](/absolute/path/doc.md?include=true)";
  ...
  it("should extract an inline link with ?include=true&inline=true", () => {
    const content = "[inline link](./inline.md?include=true&inline=true)";
  ...
  it("should extract an inline link with ?include=1&inline=1", () => {
    const content = "[inline link](./inline.md?include=1&inline=1)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract an inline link with specific lines range ?lines=45-100", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=45-100)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract an inline link with lines range starting from 0 ?lines=-100", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=-100)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract an inline link with lines range ending at 'end' ?lines=34-", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=34-)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract an inline link with lines range ending at 'end' ?lines=34-end", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=34-end)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should ignore lines parameter if inline is not true", () => {
    const content = "[link](./doc.md?include=true&lines=10-20)";
  ...
  it("should ignore invalid lines format and log warning", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=abc-def)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should ignore lines range where start > end and log warning", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=100-50)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should ignore lines format with multiple hyphens and log warning", () => {
    const content = "[inline link](./inline.md?include=true&inline=true&lines=10-20-30)";
    const relativeLink = "./inline.md";
    const expectedAbsolutePath = `${SOURCE_DIR}/${relativeLink}`;
  ...
  it("should extract a mix of inline and non-inline links", () => {
    const content = `
      [Normal Link](./normal.md?include=true)
      [Inline Link 1](./inline1.md?include=true&inline=true&lines=10-20)
      [Inline Link 2](./inline2.md?include=1&inline=1&lines=-5)
      [Ignored Link](./ignored.md)
      [Normal Link 2](../normal2.md?include=1)
      [Inline Link 3](./inline3.md?include=1&inline=1&lines=50-)
    `;
